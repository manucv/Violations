...
-- Dumping data for table violationsg.aplicacion: ~103 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `cli_cod_pais` varchar(4) NOT NULL,
  `cli_cod_ciudad` varchar(4) NOT NULL,
...
INSERT INTO `cliente` (`cli_id`, `usu_id`, `cli_saldo`, `cli_foto`, `cli_cod_pais`, `cli_cod_ciudad`, `cli_direccion`, `cli_movil`) VALUES
	(1, 3, 700.00, NULL, '56', '02', '', '0995661449');
...
-- Dumping data for table violationsg.log_parqueadero: ~2 rows (approximately)
...
INSERT INTO `log_parqueadero` (`log_par_id`, `par_id`, `aut_placa`, `log_par_fecha_ingreso`, `log_par_fecha_salida`, `log_par_horas_parqueo`, `log_par_estado`, `tra_id`) VALUES
	...
	(6, 'Q025', 'PER591', '2014-10-20 21:26:37', '0000-00-00 00:00:00', 2, 'D', 2);
...
-- Dumping data for table violationsg.menu: ~28 rows (approximately)
DELETE FROM `menu`;
...
-- Dumping data for table violationsg.rol_aplicacion: ~165 rows (approximately)
...
-- Dumping data for table violationsg.transaccion: ~2 rows (approximately)
DELETE FROM `transaccion`;
/*!40000 ALTER TABLE `transaccion` DISABLE KEYS */;
INSERT INTO `transaccion` (`tra_id`, `eta_id`, `cli_id`, `tra_valor`, `tra_saldo`, `tra_fecha`) VALUES
	(1, 1, 1, 0.40, 0.00, '0000-00-00 00:00:00'),
	(2, 1, 1, 0.80, 0.00, '0000-00-00 00:00:00');
